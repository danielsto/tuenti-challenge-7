...
if __name__ == '__main__':
    ...
    for node in [1, 3, 4, 5, 8, 9]:
        graph.add_node(node)

    graph.add_edge(1, 9, 36)
    ...
    # graph.add_edge(8, 5, 0)
    graph.add_edge(8, 9, 8)
    # graph.add_edge(9, 8, 0)
    # graph.add_edge(5, 4, 0)  # cómo carajo añadir esta
    print("NODOS: ", graph.nodes)
    print("GRAFO: ", graph.edges)

    print("DIJSKTRA", shortest_path(graph, 1, 9))